<!-- Menggunakan layout public yang baru saja kita buat -->
@extends('layouts.public')

@section('content')
    <!-- HERO SECTION (Bagian Atas Sesuai Referensi Gambar) -->
